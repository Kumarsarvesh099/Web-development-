export const SOCIAL_LINKS = [
  { name: 'GitHub', icon: 'FaGithub', href: 'https://github.com/Sarvesh099' },
  { name: 'LinkedIn', icon: 'FaLinkedin', href: 'https://linkedin.com/' },
  { name: 'LeetCode', icon: 'SiLeetcode', href: 'https://leetcode.com/' },
  { name: 'Email', icon: 'MdEmail', href: 'mailto:kumarsarvesh09931@gmail.com' },
  { name: 'Twitter', icon: 'FaXTwitter', href: 'https://twitter.com/' },
  { name: 'Instagram', icon: 'FaInstagram', href: 'https://instagram.com/' },
]

export const CONTACT_INFO = {
  email: 'kumarsarvesh09931@gmail.com',
  phone: '+919956392566',
